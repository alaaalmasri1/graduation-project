...
<button id="topBtn" style="margin-right:10px; data-toggle=tooltip"  title="الرجوع الى اعلى"><i class="fas fa-arrow-up" style="margin-right:10px;"></i></button>
<!--loading-->
<div class="LogosArea">
    <div class="container">
        <div class="col-md-3">
...
<section id="header">
  ...
  bottom: -5px; left:20px;"><img src="images/themes.png"></button>
                            </li>

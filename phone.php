...
{
    if(empty($_post['name']&&$_POST['mob'])&&$_POST['email']&&$_POST['question'])
    {
    ...
    $course="دورة صيانة الهواتف الخلوية";
...
<div class="container">
    ...
    <center>
		<div class="form_main">
                <h4 class="heading"><strong>دورة  </strong>صيانة الهواتف الخلوية<span></span></h4>
                <div class="form">
                <form action="phone.php" method="post" id="contactFrm" name="contactFrm">
                    <input type="text" dir=rtl  placeholder="ادخل الاسم " value="" name="name" class="txt">
                    <input type="text" dir="rtl"  placeholder="ادخل رقم الهاتف" value="" name="mob" class="txt">
                    <input type="text" dir="rtl"  placeholder="البريد الالكترونى" value="" name="email" class="txt">
